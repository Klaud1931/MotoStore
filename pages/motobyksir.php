  ...
  <div class="wrapper row1">
    <header id="header" class="hoc clear"> 
      <div id="logo" class="fl_left">
        <h1><a download href = "applic/WindowsFormsApp18.rar3">MotoStore</a></h1>
      </div>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <div class="content three_quarter"> 
      <?php
      for ($i = 0; $i < count($newsb); $i++) {
       echo '<img src="img/byks/'.$newsb[$i]["id"].'.jpg">
       <h2>'.$newsb[$i]["titleb"].'</h2>
       <p>'.$newsb[$i]["textb"].'</p>';
       if($i == 0)
