  ...
  <div class="wrapper row1">
    <header id="header" class="hoc clear"> 
      <div id="logo" class="fl_left">
        <h1><a download href = "WindowsFormsApp18.rar">MotoStore</a></h1>
      </div>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <div class="content three_quarter"> 
      <?php
      for ($i = 0; $i < count($newsk); $i++) {
       echo '<img src="img/kvadro/'.$newsk[$i]["id"].'.jpg">
       <h2>'.$newsk[$i]["titlek"].'</h2>
       <p>'.$newsk[$i]["textk"].'</p>';
       if($i == 0)
